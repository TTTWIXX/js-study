...
while (true) {
    var userAccount = prompt(`account 입력하세요`)
    var userCopy = null;
    ...
    if (userCopy !== null) {
        if(userCopy.password===userPassword){
            alert(userCopy.username)
...
// while(true){
// var inputAccount=prompt(`계정을를 입력하세요`)

// if(inputAccount!==userInfo.userList[0].account &&inputAccount!==userInfo.userList[1].account&&
//     inputAccount!==userInfo.userList[2].account){
//         alert("존재하지 않는 회원입니다.")
// }

// var inputPassWord=prompt(`비밀번호를 입력하세요`)

// if(inputAccount===userInfo.userList[0].account && inputPassWord===userInfo.userList[0].password
//     ){
//         alert(`${userInfo.userList[0].username}님 환영합니다.`)
//         break;
// }
// else if (inputAccount===userInfo.userList[1].account && inputPassWord===userInfo.userList[1].password){
//     alert(`${userInfo.userList[1].username}님 환영합니다.`)
//     break;
// }
// else if (inputAccount===userInfo.userList[2].account && inputPassWord===userInfo.userList[2].password){
//     alert(`${userInfo.userList[2].username}님 환영합니다.`)
//     break;
// }else{
//     alert(`비밀번호가 틀렸습니다.`)
// }
